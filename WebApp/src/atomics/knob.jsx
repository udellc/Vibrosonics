  ...
  return (
    ...
    <div className="flex items-center font-bold text-sm">
      ...
      <div className="w-[100px] h-[100px] flex items-center justify-center border-2 relative">
        <div onMouseDown={handleMouseDown} className="w-[75px] h-[75px] bg-gray-800 border-2 border-gray-600 rounded-full relative cursor-ns-resize shadow-lg active:border-yellow-400 transition-colors">
          {/* Knob */}
          <div className="w-[75px] h-[75px] bg-gray-800 border-2 rounded-full">
            
            {/* Rotator */}
            <div className="w-full h-full absolute top-0 left-0 rounded-full pointer-events-none"
