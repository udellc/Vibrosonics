...
const PRESET_STATIONS = [
  ...
  {
    name: "Classic Rock",
    url: "http://streaming.exclusive.radio/er/classicrock/icecast.audio",
  },
];
  ...
  return (
    <div className="flex flex-col min-h-[80vh] items-center justify-center gap-4">
      ...
      <div className="relative w-full max-w-xs flex items-center">
        <label className="block mb-2 w-40">Choose a Station:</label>
        <div
      ...
      <button
        className="bg-amber-200 border border-amber-600 hover:bg-amber-600 rounded-xl px-4"
