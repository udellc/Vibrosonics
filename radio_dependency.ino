...
#define RESET_PIN 13  // On Arduino Atmega328 based board, this pin is labeled as A0 (14 means digital pin instead analog)
#define SDA_PIN 23    //

// I2C bus pin on ESP32
#define ESP32_I2C_SDA 23
...
void setup() {
  ...
  delay(1);
  digitalWrite(RESET_PIN, HIGH);  // HIGH == inactive reset
  delay(10);                      // give time for chip to initialize
  ...
  Serial.println("\Station 88.7MHz");
  rx.setFrequency(8770);  // It is the frequency you want to select in MHz multiplied by 100.
